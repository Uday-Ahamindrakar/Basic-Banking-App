...
import com.example.Bank.Database.UserContract.UserEntry;
...
public class UserHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        // Insert Into Table
        db.execSQL("insert into " + TABLE_NAME + " values(7860,'Uday Ahamindrakar', 'udayjain3421','7584','7895641238', 15000)");
        db.execSQL("insert into " + TABLE_NAME + " values(5862,'Pavan Patel', 'pavan@gmail.com','1258','8995641238', 5000)");
        db.execSQL("insert into " + TABLE_NAME + " values(7895,'Akash Gulathi', 'Akkash@gmail.com','8896','7595645896', 1000)");
        db.execSQL("insert into " + TABLE_NAME + " values(1258,'Sandesh Aaher', 'Sandesh@gmail.com','7752','9995640038', 8000)");
